  ...
  <main>
    ...
    <div class="modal-overlay">
      <div id="modal">
        ...
        <div id="form">
          ...
          <h3>Você completou a região Centro-Oeste e recebeu sua segunda estrela!</h3>
        </div>
      </div>
    </div>
    ...
    <div class="conteudo">
      ...
      <div class="texto">
        ...
        <p class="nordestep">O clima quente do Nordeste é a principal característica dessa região. Seus 9 estados são
          ...
          Atlântico.</p>
        <button class="jogar"><a href="nordeste.html">Jogar</a></button>
      </div>
    </div>
    ...
    <div class="conteudobackground">
      <div class="texto" id="textosudeste">
        ...
        <button><a href="#">bloqueado</a></button>
      </div>
